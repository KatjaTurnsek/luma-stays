        ...
        <div className="container static-page__container">
          <div className="static-page__section">
            ...
            <p>
              ...
              register, log in, create bookings, and manage venues depending on
              their account type.
            </p>
          </div>
          ...
          <div className="static-page__section">
            ...
            <p>
              ...
              Customers can create and view bookings. Venue managers can create,
              edit, and delete venues they manage.
            </p>
          </div>
          ...
          <div className="static-page__section">
            <h2>Venue content</h2>
            <p>
              Venue managers are responsible for the venue information they add,
              including names, descriptions, images, prices, facilities, and
              guest limits.
            </p>
          </div>
