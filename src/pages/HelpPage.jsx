...
export default function HelpPage() {
  return (
    <>
      <PageMeta
        title="Help | Luma Stays"
        description="Find help and guidance for using Luma Stays, including booking stays, managing venues, and account options."
      />
          ...
          <div className="container static-page__container">
            <div className="static-page__section">
              ...
              <div className="static-page__text-block">
                ...
                <p>
                  Use the search field on the home page or explore all stays
                  from the venues page. You can search by location or stay name,
                  add a guest count, and sort the results.
                </p>
              </div>
              ...
              <div className="static-page__text-block">
                ...
                <p>
                  ...
                  calendar, select the number of guests, and confirm the
                  booking. You need to be logged in as a customer to create a
                  booking.
                </p>
              </div>
            ...
            <div className="static-page__section">
              ...
              <div className="static-page__text-block">
                ...
                <p>
                  Register or log in as a venue manager, then use the Create
                  venue button in the header, footer, or profile page.
                </p>
              </div>
              ...
              <div className="static-page__text-block">
                ...
                <p>
                  Yes. Venue managers can edit and delete venues they own from
                  the profile page.
                </p>
              </div>
